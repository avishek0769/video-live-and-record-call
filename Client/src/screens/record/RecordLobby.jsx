        ...
        <div style={styles.container}>
            <div style={styles.card}>
                <div style={styles.header}>
                    ...
                    <h1 style={styles.title}>Join Recording Session</h1>
                    <p style={styles.subtitle}>Enter a room ID to start recording your video session</p>
                </div>
...
const styles = {
    ...
    icon: {
        fontSize: '36px',
        marginBottom: '12px',
        filter: 'drop-shadow(0 0 12px rgba(76, 205, 196, 0.5))',
    },
    title: {
        fontSize: '24px',
        fontWeight: '700',
    ...
    buttonEnabled: {
        ...
        boxShadow: '0 6px 24px rgba(76, 205, 196, 0.3)',
    },
    buttonDisabled: {
        backgroundColor: 'rgba(255, 255, 255, 0.05)',
        color: '#666',
